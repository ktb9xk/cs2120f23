...
variable
  ...
  (Mortal : Person → Prop)                            --the property of being mortal
  (everyone_is_mortal : ∀ (p : Person), Mortal p )    --proof all people are mortal
#check everyone_is_mortal Socrates --universal specialization: Socrates is mortal
end socrates
